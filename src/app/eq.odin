...
generate_curve_points :: proc(coeffs: Biquad_Coefficients, sample_rate: f64) -> [FREQ_RESP_BINS]f64 {
    curve: [FREQ_RESP_BINS]f64
    min_freq := 20.0
    max_freq := 20000.0

    for i in 0..<FREQ_RESP_BINS {
        t    := f64(i) / f64(FREQ_RESP_BINS - 1)
